...
@SpireInitializer
public class CenturionMod implements
        EditCardsSubscriber,
    ...
    private static final String ATTACK_DEFAULT_GRAY = "centurionResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "centurionResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "centurionResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "centurionResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "centurionResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "centurionResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "centurionResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "centurionResources/images/1024/bg_power_default_gray.png";
    ...
    public CenturionMod() {
      ...
      */
        ...
        logger.info("Creating the color " + Centurion.Enums.COLOR_GRAY.toString());
        
        BaseMod.addColor(Centurion.Enums.COLOR_GRAY, DEFAULT_GRAY, DEFAULT_GRAY, DEFAULT_GRAY,
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = centurion.CenturionMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = centurion.CenturionMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = centurion.CenturionMod.class.getPackage().getName(); // STILL NO EDIT ZONE
