...
public class CardTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = centurion.CenturionMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("Strike_Centurion.png");// "public static final String IMG = makeCardPath("${NAME}.png");
